...
@section('content')
    <div class="container" style="margin-top:1em">
        <div class="carousel">
            @foreach($templates as $template)
                <a id="{{$template->business_id}}" class="carousel-item tooltipped" onclick="goToBiz(this)"
                   data-position="bottom"
                   data-tooltip="{{$template->business_name . ' - ' . $template->service_description}}"
                   href="{{'#car_'.$template->id.'!'}}">
    ...
    <div class="fixed-action-btn">
        ...
        <ul>
            <li><a class="btn-floating red tooltipped" data-position="left" data-tooltip="Emergency Contact"><i
                            class="material-icons">call</i></a></li>
            <li><a class="btn-floating yellow darken-1 tooltipped" data-position="left" data-tooltip="Contact Us"><i
                            class="material-icons">email</i></a></li>
            <li><a class="btn-floating tooltipped" data-position="left" data-tooltip="About us & Privacy Policy"><i
                            class="material-icons">info_outline</i></a></li>
            <li><a class="btn-floating blue tooltipped" data-position="left" data-tooltip="Navigator"><i
                            class="material-icons">gps_fixed</i></a></li>
        </ul>
    </div>
