...
@section('content')
    <div class="container" style="margin-top:3em;">
        ...
        <h6 class="text-center text-capitalize" style="margin-top:0.5em;">Verify and Complete missing information</h6>
        <div class="row">
            <form class="col s12 card" method="post" action="{{url('template_selection_biz')}}">
                {{ csrf_field()}}
                <div class="row">
